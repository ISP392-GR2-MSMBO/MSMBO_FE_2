    ...
    return (
        <div className="policy-container">
            ...
            <div className="policy-content">
                ...
                <ul>
                    <li>Chill Cinema thu thập thông tin cá nhân (Họ tên, Email, Số điện thoại) khi bạn đăng ký tài khoản và thực hiện giao dịch đặt vé. Việc thu thập này nhằm mục đích quản lý đơn hàng và hỗ trợ khách hàng.</li>
                </ul>
                ...
                <ul>
                    <li>Chill Cinema cam kết không bán, trao đổi hoặc chuyển giao thông tin cá nhân của bạn cho bất kỳ bên thứ ba nào, trừ trường hợp có yêu cầu từ cơ quan pháp luật.</li>
                </ul>
            </div>
        </div>
    );
